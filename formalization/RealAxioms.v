  ...
  Class SemiDecOrderedField_Real (types : RealTypes) :=
    {
      ...
      real_mult : @Real types -> @Real types -> @Real types;
      real_opp : @Real types -> @Real types;
      real_inv : forall {z}, z <> real_0 -> @Real types;
      real_lt : @Real types -> @Real types -> Prop;
      real_lt_semidec : forall x y : @Real types, semidec (real_lt x y);

      real_plus_comm : forall r1 r2 : @Real types, real_plus r1 r2 = real_plus r2 r1;
      real_plus_assoc : forall r1 r2 r3 : @Real types, real_plus (real_plus r1 r2) r3 = real_plus r1 (real_plus r2 r3);
      real_plus_inv : forall r : @Real types, real_plus r (real_opp r) = real_0;
      real_plus_unit : forall r : @Real types, real_plus real_0 r = r;
      real_mult_comm : forall r1 r2 : @Real types, real_mult r1 r2 = real_mult r2 r1;
      real_mult_assoc : forall r1 r2 r3 : @Real types, real_mult (real_mult r1 r2) r3 = real_mult r1 (real_mult r2 r3);
      real_mult_inv : forall (r : @Real types) (p : r <> real_0), real_mult (real_inv p) r = real_1;
      real_mult_unit : forall r : @Real types, real_mult real_1 r = r;
      real_mult_plus_distr: forall r1 r2 r3 : @Real types, real_mult r1 (real_plus r2 r3) = real_plus (real_mult r1 r2) (real_mult r1  r3);

      real_1_neq_0 : real_1 <> real_0;
      real_1_gt_0 : real_lt real_0 real_1;

      real_total_order : forall r1 r2 : @Real types, real_lt r1 r2 \/ r1 = r2 \/ real_lt r2 r1;
      real_lt_nlt : forall r1 r2 : @Real types, real_lt r1 r2 -> ~ real_lt r2 r1;
      real_lt_lt_lt : forall r1 r2 r3 : @Real types, real_lt r1 r2 -> real_lt r2 r3 -> real_lt r1 r3;
      real_lt_plus_lt : forall r r1 r2 : @Real types, real_lt r1 r2 -> real_lt (real_plus r r1) (real_plus r r2);
      real_lt_mult_pos_lt : forall r r1 r2 : @Real types, real_lt real_0 r -> real_lt r1 r2 -> real_lt (real_mult r r1) (real_mult r r2);
    }.
...
Notation "/ p" := (real_inv p ) : Real_scope.
