...
#[local] Notation "^Real" := (@Real types) (at level 0).
  ...
  Lemma relate_divison : forall x (p : x <> real_0) a, relate x a -> relate (/ p) (/a)%R. 
  Proof.
    intros.
    unfold relate.
    case_eq (relator (/p)).
  ...
  Definition Holber0: forall x, relate real_0 x -> x = R0.
  Proof.
    intros.
  ...
  Definition Holber1: forall x, relate real_1 x -> x = R1.
  Proof.
    intros.
  ...
  Definition Holber6 : forall a  x  z (p : x <> real_0), relate x a -> relate (/p) z ->
                                                        z = (/a)%R.
  Proof.
    intros.
  ...
  Definition Holber7 : forall a b x y z (p : y <> real_0), relate x a -> relate y b -> relate (x / p) z -> z = (a/b)%R.
  Proof.
    intros.
