...
lazy_bool_or :: AERN2.CKleenean -> AERN2.CKleenean ->
                AERN2.CKleenean
lazy_bool_or = (OGB.||)

m_base_monad_traces_lift :: (M a1) -> (Prelude.Integer
                            -> a1 -> M a1) ->
...
m_paths :: (M a1) -> (Prelude.Integer -> a1 -> M 
           a1) -> M (Prelude.Integer -> a1)
m_paths x x0 =
...
real_mslimit_P_lt_p :: (Prelude.Integer -> M
...
abs_prop x =
  real_mslimit_P_lt_p (\n ->
    ...
    m_lift x0
      (m_split x real_0
        (prec
          ((Prelude.+) n (Prelude.succ (Prelude.succ
            0))))))
...
real_limit :: (Prelude.Integer -> AERN2.CReal) ->
              AERN2.CReal
real_limit =
  real_limit_p

real_limit_P_lt :: (Prelude.Integer -> AERN2.CReal) ->
                   AERN2.CReal
real_limit_P_lt =
  real_limit_P_lt_p

real_mslimit_P_lt :: (Prelude.Integer -> M AERN2.CReal)
                     -> AERN2.CReal
real_mslimit_P_lt x =
  let {x0 = m_countable_lift x} in
  m_hprop_elim_f (m_lift real_limit_P_lt x0)

real_max_prop :: AERN2.CReal -> AERN2.CReal ->
                 AERN2.CReal
real_max_prop x y =
  real_mslimit_P_lt (\n ->
    mjoin (\h ->
...
euclidean_rect :: RealTypes -> a1 -> (Prelude.Integer
                  -> AERN2.CReal -> Euclidean -> a1 ->
                  a1) -> Prelude.Integer -> Euclidean
                  -> a1
euclidean_rect types f f0 _ e =
  case e of {
   Nil -> f;
   Cons n r e0 ->
    f0 n r e0 (euclidean_rect types f f0 n e0)}
...
rect2 :: a1 -> (Prelude.Integer -> Euclidean ->
         Euclidean -> a1 -> AERN2.CReal -> AERN2.CReal
         -> a1) -> Prelude.Integer -> Euclidean ->
         Euclidean -> a1
rect2 bas rect _ v1 v2 =
  case v1 of {
   ...
   Cons n' h1 t1 ->
    caseS' n' v2 (\h2 t2 ->
      rect n' t1 t2 (rect2 bas rect n' t1 t2) h1 h2)}
...
euclidean_plus :: Prelude.Integer -> Euclidean ->
                  Euclidean -> Euclidean
euclidean_plus n x y =
  rect2 Nil (\n0 _ _ x0 a b -> Cons n0 ((+) a b) x0) n
    x y

euclidean_opp :: Prelude.Integer -> Euclidean ->
                 Euclidean
euclidean_opp n x =
  nat_rect (\_ -> Nil) (\n0 iHn x0 ->
...
euclidean_minus :: Prelude.Integer -> Euclidean ->
                   Euclidean -> Euclidean
euclidean_minus n x y =
  euclidean_plus n x (euclidean_opp n y)

euclidean_max_norm :: Prelude.Integer -> Euclidean ->
                      AERN2.CReal
euclidean_max_norm n x =
  euclidean_rect __
    {- 1st argument (types) of euclidean_max_norm -}
    real_0 (\_ r _ iHx -> real_max (abs r) iHx) n x

euclidean_max_dist :: Prelude.Integer -> Euclidean ->
                      Euclidean -> AERN2.CReal
euclidean_max_dist n x y =
  euclidean_max_norm n (euclidean_minus n x y)

euclidean_head_sequence :: RealTypes -> Prelude.Integer
                           -> (Prelude.Integer ->
                           Euclidean) ->
                           Prelude.Integer ->
                           AERN2.CReal
euclidean_head_sequence _ n f h =
  let {x = f h} in
  let {s = dim_succ_destruct n x} in
  case s of {
   (,) x0 _ -> x0}

euclidean_tail_sequence :: RealTypes -> Prelude.Integer
                           -> (Prelude.Integer ->
                           Euclidean) ->
                           Prelude.Integer -> Euclidean
euclidean_tail_sequence _ n f h =
  let {x = f h} in
  let {s = dim_succ_destruct n x} in
  case s of {
   (,) _ p -> p}

euclidean_limit :: Prelude.Integer -> (Prelude.Integer
                   -> Euclidean) -> Euclidean
euclidean_limit n f =
  nat_rect (\_ _ -> Nil) (\n0 iHn f0 _ -> Cons n0
    (
      (real_limit
        (euclidean_head_sequence __
          {- 1st argument (types) of euclidean_limit -}
          n0 f0)))
    (
      (iHn
...
euclidean_mlimit_PQ :: Prelude.Integer -> (M
                       ((,) Euclidean a1)) ->
                       (Prelude.Integer -> Euclidean ->
                       () -> a1 -> M
                       ((,) Euclidean a1)) -> M
...
complex :: RealTypes -> AERN2.CReal -> AERN2.CReal ->
           Complex
complex _ r i =
  Cons (Prelude.succ 0) r (Cons 0 i Nil)

complex_destruct :: RealTypes -> Complex -> (,)
                    AERN2.CReal AERN2.CReal
complex_destruct _ x =
  let {s = dim_succ_destruct (Prelude.succ 0) x} in
  case s of {
   (,) x0 p -> (,) x0
    (let {s0 = dim_succ_destruct 0 p} in
     case s0 of {
      (,) x1 _ -> x1})}
...
complex_nonzero_cases :: AERN2.CReal -> AERN2.CReal ->
                         M
                         (Prelude.Maybe
                         (Prelude.Maybe P.Bool))
  ...
  ssr_have __ (\_ ->
    ssr_have __ (\_ ->
      m_lift_dom (\_top_assumption_ ->
        let {
         _evar_0_ = \_ ->
          m_unit (Prelude.Just (Prelude.Just P.True))}
        in
        let {
         _evar_0_0 = \_ ->
          m_lift_dom (\_top_assumption_0 ->
            let {
             _evar_0_0 = \_ ->
              m_unit (Prelude.Just (Prelude.Just
                P.False))}
            in
            let {
             _evar_0_1 = \_ ->
              m_lift_dom (\_top_assumption_1 ->
                let {
                 _evar_0_1 = \_ ->
                  m_unit (Prelude.Just Prelude.Nothing)}
                in
                let {
                 _evar_0_2 = \_ ->
                  m_unit Prelude.Nothing}
                in
...
csqrt_neq0 z =
  let {
   s = complex_destruct __
         {- 1st argument (types) of csqrt_neq0 -} z}
  in
  case s of {
   (,) x p ->
    eq_rect_r
      (complex __
        {- 1st argument (types) of csqrt_neq0 -} x p)
      (\_ ->
      ssr_have (complex_nonzero_cases x p)
        (ssr_have __ (\_ ->
          let {x0 = sqrt ((+) ((P.*) x x) ((P.*) p p))}
          in
          ssr_have __ (\_ ->
            ssr_have __ (\_ ->
              ssr_have __ (\_ ->
                let {x1 = sqrt ((/) ((+) x0 x) real_2)}
                in
                let {x2 = sqrt ((/) ((-) x0 x) real_2)}
                in
                ssr_have __ (\_ ->
                  ssr_have __ (\_ ->
                    ssr_have __ (\_ ->
