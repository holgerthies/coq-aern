...
sub :: Prelude.Integer -> Prelude.Integer ->
       Prelude.Integer
...
npow2 n =
  (\fO fS n -> if n Prelude.== 0 then fO () else fS (n Prelude.- 1))
    (\_ -> Prelude.succ 0)
    (\n0 ->
    (Prelude.*) (npow2 n0) (Prelude.succ (Prelude.succ 0)))
    n
...
rect2 :: a1 -> (Prelude.Integer -> Euclidean -> Euclidean
         -> a1 -> AERN2.CReal -> AERN2.CReal -> a1) ->
         Prelude.Integer -> Euclidean -> Euclidean -> a1
...
euclidean_plus :: Prelude.Integer -> Euclidean -> Euclidean
                  -> Euclidean
euclidean_plus n x y =
  rect2 Nil (\n0 _ _ x0 a b -> Cons n0 ((+) a b) x0) n x y

euclidean_scalar_mult :: Prelude.Integer -> AERN2.CReal ->
                         Euclidean -> Euclidean
...
change_rad :: Prelude.Integer -> (([]) Ball) ->
              Prelude.Integer -> ([])
...
is_covert_lim :: Prelude.Integer -> (Prelude.Integer -> (,)
                 Euclidean_subset ((,) Is_covert ())) ->
                 Is_covert
is_covert_lim d x p =
  ...
  case s of {
   (,) _ p0 ->
    case p0 of {
     (,) a _ ->
      let {s0 = a (Prelude.succ p)} in change_rad d s0 p}}

is_covert_union :: Prelude.Integer -> Is_covert ->
                   Is_covert -> Is_covert
is_covert_union _ h1 h2 n =
  let {s = h1 n} in let {s0 = h2 n} in app s s0

is_covert_translation :: Prelude.Integer -> Euclidean ->
                         Is_covert -> Is_covert
is_covert_translation d a h n =
  let {s = h n} in
  map (\b -> (,) (euclidean_plus d (fst b) a) (snd b)) s
...
scale_list d l l0 =
  case l of {
   ([]) -> ([]);
   (:) b l' -> (:) ((,)
    (euclidean_scalar_mult d l0 (fst b))
    ((P.*) l0 (snd b))) (scale_list d l' l0)}

is_covert_scale_down :: Prelude.Integer -> Prelude.Integer
                        -> Is_covert -> Is_covert
...
tn_ball :: Prelude.Integer -> Prelude.Integer ->
...
tn_ball n k j =
  make_ball2
    ((P.*)
      (nreal
        ((Prelude.+)
          ((Prelude.*) (Prelude.succ (Prelude.succ 0)) k)
          (Prelude.succ 0))) (prec (Prelude.succ n)))
    ((P.*)
      (nreal
        ((Prelude.+)
          ((Prelude.*) (Prelude.succ (Prelude.succ 0)) j)
          (Prelude.succ 0))) (prec (Prelude.succ n)))
    (prec (Prelude.succ n))

tn_col :: Prelude.Integer -> Prelude.Integer ->
          Prelude.Integer -> (([]) Ball) -> ([]) Ball
tn_col n k j l =
  (\fO fS n -> if n Prelude.== 0 then fO () else fS (n Prelude.- 1))
    (\_ -> (:) (tn_ball n k 0) l)
...
tn_row :: Prelude.Integer -> Prelude.Integer -> (([]) 
          Ball) -> ([]) Ball
tn_row n k l =
  (\fO fS n -> if n Prelude.== 0 then fO () else fS (n Prelude.- 1))
    (\_ ->
    tn_col n 0 (sub (npow2 n) (Prelude.succ 0)) l)
    (\k' ->
    tn_row n k'
      (tn_col n k (sub (sub (npow2 n) k) (Prelude.succ 0))
        l))
    k
...
sierpinski_approx_is_covert n =
  nat_rect t_is_covert (\_ iHn ->
    is_covert_union (Prelude.succ (Prelude.succ 0))
      (is_covert_union (Prelude.succ (Prelude.succ 0))
        (is_covert_scale_down (Prelude.succ (Prelude.succ
          0)) (Prelude.succ 0) iHn)
        (is_covert_translation (Prelude.succ (Prelude.succ
          0))
          (make_euclidean2 (prec (Prelude.succ 0))
            (0 :: AERN2.CReal))
          (is_covert_scale_down (Prelude.succ (Prelude.succ
            0)) (Prelude.succ 0) iHn)))
      (is_covert_translation (Prelude.succ (Prelude.succ
