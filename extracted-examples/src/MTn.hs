...
empty_set_is_covert :: Is_covert
empty_set_is_covert _ =
  ([])

multi_triangles_compact :: Prelude.Integer -> Is_covert
multi_triangles_compact n =
  nat_rect empty_set_is_covert (\_ iHn ->
    is_covert_union (Prelude.succ (Prelude.succ 0)) t_is_covert
      (is_covert_translation (Prelude.succ (Prelude.succ 0))
        (make_euclidean2 (P.negate (P.recip (2 :: AERN2.CReal)))
