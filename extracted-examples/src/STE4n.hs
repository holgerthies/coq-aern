...
t4_new a b c d =
  Cons a (Prelude.succ (Prelude.succ (Prelude.succ 0)))
    (Cons b (Prelude.succ (Prelude.succ 0)) (Cons c
    (Prelude.succ 0) (Cons d 0 Nil)))
...
sTE_v4 :: Euclidean
sTE_v4 =
  make_euclidean2 real_0
    ((-) ((/) sqrt_3 (iZreal z3)) real_1)

sTE4_vs :: T Euclidean
sTE4_vs =
  t4_new sTE_v1 sTE_v2 sTE_v3 sTE_v4

sTE4_is_covert :: Is_covert
sTE4_is_covert n =
  sT_is_covert (Prelude.succ (Prelude.succ
    (Prelude.succ 0))) sTE4_vs sTE_initial_ball n
