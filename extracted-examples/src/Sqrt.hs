...
nat_rect :: a1 -> (Prelude.Integer -> a1 -> a1) -> Prelude.Integer
            -> a1
nat_rect f f0 n =
...
nat_rec :: a1 -> (Prelude.Integer -> a1 -> a1) -> Prelude.Integer ->
           a1
nat_rec =
  nat_rect
...
sqrt_approx x n =
  ssr_suff (\__top_assumption_ -> __top_assumption_)
    (nat_rec 1 (\_ __top_assumption_ ->
      ssr_have __ (\_ ->
        (Prelude.*) (Prelude.recip 2)
          ((Prelude.+) __top_assumption_
            ((Prelude./) x __top_assumption_)))) n)
