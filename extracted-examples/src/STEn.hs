...
sTE_initial_ball =
  make_ball2 (0 :: AERN2.CReal) (0 :: AERN2.CReal) (1 :: AERN2.CReal)

real_sqrt_3 :: AERN2.CReal
real_sqrt_3 =
...
sTE_v3 :: Euclidean
sTE_v3 =
  make_euclidean2 (0 :: AERN2.CReal) ((-) real_sqrt_3 (1 :: AERN2.CReal))

sTEn :: Prelude.Integer -> ([]) Ball
sTEn =
  sTn sTE_v1 sTE_v2 sTE_v3 sTE_initial_ball
